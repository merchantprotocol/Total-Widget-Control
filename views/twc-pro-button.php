...
<div id="contextual-pro-wrap" class="contextual-wrap hidden">
	<div>
		...
		<p>Welcome to the 5Twenty Studios Total Widget Control Plugin, for Wordpress 3.0+. This help section is designed to be a quick resource for new administrators. If you have questions and your answers are not found in this window, please visit our community links below.</p>
		...
		<p><strong style="color:#555;">Frequently Asked Questions:</strong></p>
		<p>As you hover over the following items, we will display information next to the item in the page.</p>
		<ul class="hot-to-twc">
		...
		<li id="qtipSwitchView" tooltip="Click here to switch back to the Wordpress Widget Screen">How do I switch back to the old widget screen?</li>
