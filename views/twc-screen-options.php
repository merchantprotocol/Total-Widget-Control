...
<ul class="hot-to-twc">
	...
	<li><?php _e('You original sidebar widgets are still displaying, <a href="'.get_bloginfo('url').'/wp-admin/widgets.php?twc_clear_originals">Click here if you want to clear out all of your originals.</a>', 'twc'); ?></li>
	<?php endif; ?>
