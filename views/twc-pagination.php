...
<div class="tablenav-pages twcp">
	...
	<a class="next page-numbers" href="<?php echo get_admin_url(); ?>widgets.php?pa=<?php echo $prev.$inactive; ?>">&laquo;</a>
	<?php endif; ?>
	...
	<?php for ($i=1; $i <= $pages; $i++): ?>
		...
		<?php elseif ($i == 1 || $i == $pages): ?>
			<a class="page-numbers" href="<?php echo get_admin_url(); ?>widgets.php?pa=<?php echo $i.$inactive; ?>"><?php echo $i; ?></a>
	...
	<?php if ($page < $pages): ?>
	<a class="next page-numbers" href="<?php echo get_admin_url(); ?>widgets.php?pa=<?php echo $next.$inactive; ?>">&raquo;</a>
	<?php endif; ?>
</div>
