...
<div class="view-switch">
	<a href="<?php echo get_admin_url(); ?>widgets.php?list_style=twc"><img class="current qtipTwc qtipTopMiddle" id="view-switch-list" 
	...
	<a href="<?php echo get_admin_url(); ?>widgets.php?list_style=wp"><img id="view-switch-excerpt" 
