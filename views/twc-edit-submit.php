	...
	<div class="widget-publishing-actions">
		...
		<div id="major-publishing-actions">
			...
			<div id="publishing-action">
				...
				<input type="submit" class="button-primary" onClick="javascript:jQuery('#twc-redirect').val('<?php bloginfo('url');?>/wp-admin/widgets.php'); return twc_save_widget_edit();" id="twc-save-continue" value="<?php _e('Save and Continue', 'twc'); ?>" />
			</div>
			<div class="clear"></div>
		</div>
	</div>
