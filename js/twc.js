...
jQuery(document).ready(function(){
	...
	jQuery('.edit-visibility:first').click(function(){jQuery('#post-visibility-select').slideToggle();});
	jQuery('.edit-timestamp:first').click(function(){jQuery('#timestampdiv').slideToggle();});
	jQuery('.twcp_toggler_status').click(function(){twc_update_status();jQuery('#post-status-select').slideToggle();});
